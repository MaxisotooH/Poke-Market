"""
Django settings for pokeMarketProject project.
...
SECRET_KEY = 'django-insecure-2iwd=l4!v_n*#-ahit@bxfg5_rqb7(i#l6s9thpl+rbms+2ni!'
...
ROOT_URLCONF = 'pokeMarketProject.urls'
...
WSGI_APPLICATION = 'pokeMarketProject.wsgi.application'
...
# Vista a la que Django redirige si un usuario no autenticado intenta
# entrar a una página protegida con @login_required (ej: el perfil).
